    ...
    <span
      title={
        source === "measured"
          ...
          : source === "model"
            ? "Generated by Claude Sonnet 4.6 from frames + transcript. Subject to model judgement."
            : "Estimated impact — Claude's projection, not measured. Treat as directional."
      }
