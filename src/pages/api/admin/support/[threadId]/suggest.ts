...
- Do NOT make up product features. We currently offer: AI-generated websites, contact/newsletter forms, per-site activation (annual/lifetime), Creative Direction (human + AI finish), custom domains. We do NOT have: blog CMS, e-commerce, booking calendar, event publishing.
